...
const Intro = () => {
    return (
        <section className="intro__wrapper">
            <img className="intro__illustration" src={IntroIllustration} alt="two people accessing documents from a folder" />
            <h1 className="intro__heading">All your files in one secure location, accessible anywhere.</h1>
